**This document compiles commonly used models and datasets in the field of zero-shot image classification. We will periodically update it to ensure it includes the latest research advancements.**
